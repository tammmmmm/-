...
local library = {
    ...
    theme = {
        buttons = Color3.fromRGB(60, 195, 30), -- toggle, sliders colors
        text = Color3.fromRGB(255, 255, 255),
        textboxtext = Color3.fromRGB(145, 145, 145),
        main = Color3.fromRGB(190, 7, 5), -- main outline of gui + button stuff
        outline = Color3.fromRGB(0, 0, 0), -- 1px line around everything
        tabholder = Color3.fromRGB(20, 20, 20), -- tab location
        tabbutton = Color3.fromRGB(40, 40, 40), -- just a tab
        tabselected = Color3.fromRGB(20, 20, 20)	
    }
}
